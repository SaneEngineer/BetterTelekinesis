//Taken from https://github.com/mwilsnd/SkyrimSE-SmoothCam/blob/master/SmoothCam/include/mmath.h
#pragma once
...
namespace mmath
{
	...
	glm::mat4 LookAt(const glm::vec3& pos, const glm::vec3& at) noexcept;
