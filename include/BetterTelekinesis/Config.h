...
namespace BetterTelekinesis
{
	...
	public:
		...
		static inline double BaseDistanceMultiplier = 2.0f;
		static inline double BaseDamageMultiplier = 5.0f;
		static inline double ObjectPullSpeedBase = 200.0f;
		static inline double ObjectPullSpeedAccel = 10000.0f;
		static inline double ObjectPullSpeedMax = 8000.0f;
		static inline double ObjectThrowForce = 4.0f;
		static inline double ObjectHoldDistance = 1.0f;
		static inline double ActorPullSpeed = 8000.0f;
		static inline double ActorThrowForce = 2.0f;
		static inline double ActorHoldDistance = 1.5f;
		...
		static inline double ObjectTargetPickerRange = 500.0f;
		static inline double ActorTargetPickerRange = 200.0f;
		static inline int DontPickFriendlyTargets = 1;
		static inline int TelekinesisMaxObjects = 10;
		static inline double TelekinesisObjectSpread = 15.0f;
		...
		static inline double OverwriteTelekinesisSpellBaseCost = -1.0f;
		...
		static inline double TelekinesisTargetUpdateInterval = 0.2f;
		...
		static inline double MagicSword_RemoveDelay = 6.0f;
		static inline double MagicSwordBlast_PlaceDistance = 300.0f;
		static inline double MagicSwordBarrage_PlaceDistance = 200.0f;
		static inline double SwordBarrage_FireDelay = 0.5f;
		static inline double SwordBarrage_SpawnDelay = 0.15f;
		...
		constexpr static inline std::string_view iniPath = "Data/SKSE/Plugins/BetterTelekinesis.ini";
	};
}
